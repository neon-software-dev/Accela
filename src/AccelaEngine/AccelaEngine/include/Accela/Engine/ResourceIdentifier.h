...
{
    class ACCELA_PUBLIC ResourceIdentifier
    {
        public:
    ...
    struct ACCELA_PUBLIC PackageResourceIdentifier : public ResourceIdentifier
    {
    ...
    struct ACCELA_PUBLIC CustomResourceIdentifier : public ResourceIdentifier
    {
