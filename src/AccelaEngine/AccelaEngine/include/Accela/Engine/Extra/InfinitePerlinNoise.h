...
#ifndef LIBACCELAENGINE_INCLUDE_ACCELA_ENGINE_EXTRA_INFINITEPERLINNOISE_H
#define LIBACCELAENGINE_INCLUDE_ACCELA_ENGINE_EXTRA_INFINITEPERLINNOISE_H
...
namespace Accela::Engine
{
     ...
     */
    class ACCELA_PUBLIC InfinitePerlinNoise
    {
        public:
...
#endif //LIBACCELAENGINE_INCLUDE_ACCELA_ENGINE_EXTRA_INFINITEPERLINNOISE_H
